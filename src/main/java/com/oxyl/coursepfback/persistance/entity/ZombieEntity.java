...
public class ZombieEntity {
     ...
     * @param id_zombie l'identifiant unique du zombie
     * @param nom le nom du zombie
     * @param point_de_vie les points de vie du zombie
     * @param attaque_par_seconde la fréquence d'attaque du zombie
     * @param degat_attaque les dégâts infligés par le zombie
     * @param vitesse_de_deplacement la vitesse de déplacement du zombie
     * @param chemin_image le chemin de l'image du zombie
     * @param id_map l'identifiant de la carte associée
     */
    public ZombieEntity(
            Long id_zombie,
            String nom,
    ...
    /**
     * @return l'identifiant unique du zombie
     */
    ...
    /**
     * @param id_zombie l'identifiant unique du zombie à définir
     */
    ...
    /**
     * @return la fréquence d'attaque du zombie
     */
    ...
    /**
     * @param attaque_par_seconde la fréquence d'attaque du zombie à définir
     */
    ...
    /**
     * @return le chemin de l'image du zombie
     */
    ...
    /**
     * @param chemin_image le chemin de l'image du zombie à définir
     */
    ...
    /**
     * @return l'identifiant de la carte associée
     */
    ...
    /**
     * @param id_map l'identifiant de la carte associée à définir
     */
